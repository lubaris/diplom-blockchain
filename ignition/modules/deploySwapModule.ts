...
const SwapModule = buildModule("SwapModule", (m) => {
  ...
  const token1 = m.contract("ERC20EXte", [1, "KrendelCoin", "KRENDEL"], {id: "token1"});
  const token2 = m.contract("ERC20EXte", [2, "GerdaCoin", "GERDA"], {id: "token2"});

  //0xbb4cdb9cbd36b01bd1cbaebf2de08d9173bc095c
  //0x55d398326f99059ff775485246999027b3197955
  m.call(router, "addModuleSwap", [UniswapV2SwapModule1, "pancake"], {id: "addModuleSwap1"});
  m.call(router, "addModuleSwap", [UniswapV2SwapModule2, "pancake"], {id: "addModuleSwap2"});
  m.call(router, 'addToken', [token1], {id: "addToken1"});
  m.call(router, 'addToken', [token2], {id: "addToken2"});
